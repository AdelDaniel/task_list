...
class ArchivedTasksPage extends StatelessWidget {
  static const String pageName = "Archived Tasks";
    ...
    return BlocBuilder<TaskBloc, TaskState>(
      builder: (BuildContext context, TaskState state) {
        if (state is TaskLoadingState) {
          ...
          return ArchivedTaskSeperatedListView(
            tasks: tasks,
...
class ArchivedTaskSeperatedListView extends StatelessWidget {
  const ArchivedTaskSeperatedListView({
    Key? key,
    required this.tasks,
